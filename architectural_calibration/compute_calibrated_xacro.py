...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Adjust xacro file with calibration data"
    )
    parser.add_argument("--input_xacro", type=str, help="xacro file to adjust")
    parser.add_argument("--calib", type=str, help="Calibration file")
    parser.add_argument(
        "--output_xacro", default="output.xacro", type=str, help="Output file"
    )

    args = parser.parse_args()
    adjust_urdf(args.input_xacro, args.calib, args.output_xacro)
